package behavioral.memento.editor.editor;

import behavioral.memento.editor.command.ColorCommand;
import behavioral.memento.editor.command.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                behavioral.memento.editor.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
